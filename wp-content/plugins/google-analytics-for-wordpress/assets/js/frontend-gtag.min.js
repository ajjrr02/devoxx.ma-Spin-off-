...
var MonsterInsights = function() {
        ...
        function A(e) {
            ...
            if (d.match(/^javascript\:/i)) {
                ...
                t = 'mailto'
            } else if (r && c && r.length > 0 && c.length > 0 && !r.endsWith('.' + c) && r !== c) {
                t = 'external'
            ...
            if (o && o.href && !o.hasAttribute('xlink:href')) {
                ...
                if (a !== 'internal' && a !== 'javascript') {
                    ...
                    if (x || a == 'mailto' || a == 'tel') {
                        ...
                        if (a != 'cross-hostname' && a != 'external' && a != 'internal-as-outbound') {
                        ...
                        if (a != 'external' && a != 'cross-hostname' && a != 'internal-as-outbound') {
                            setTimeout(p, 1000)
                        } else {
                            if (a == 'external') {
                                setTimeout(E, 1100)
        ...
        function p() {
            if (monsterinsights_frontend.hash_tracking === 'true' && f != window.location.hash && (monsterinsights_frontend.ua || monsterinsights_frontend.v4_id)) {
